...
class Docs extends CI_Controller
{
    ...
    public function print()
    {
        if (!empty($this->input->get('id_absen'))) {
            ...
            $mpdf->Output("absensimagang_" . time() . "_self" . "_download.pdf", "I");
        } else {
    ...
    public function export()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->input->post('method_export_file') === 'pdf') {
                ...
                $mpdf->SetTitle('Cetak Absen Pegawai');
                //$mpdf->Output(FCPATH . $pdfFilePath, "F");
                $mpdf->Output("absensimagang_" . time() . "_bulanan" . "_download.pdf", "I");
                ...
                $filename = "absensimagang_" . time() . "_bulanan" . "_download";
