            ...
            <div class="card mb-4">
                ...
                <div class="card-footer">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Kode: <?= $user['kode_pegawai'] ?></div>
        ...
        <div class="col-xl-5">
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <!-- <?= form_dropdown('ket_absen', ['Bekerja Di Bagian Otomasi' => 'Bekerja Di Bagian Otomasi', 'Bekerja Di Bagian Deposit' => 'Bekerja Di Bagian Deposit', 'Bekerja Di Bagian Pengolahan' => 'Bekerja Di Bagian Pengolahan','Bekerja Di Bagian Pelayanan' => 'Bekerja Di Bagian Pelayanan','Sakit' => 'Sakit', 'Izin' => 'Izin'], '', ['class' => 'form-control align-content-center my-2', 'id' => 'ket_absen']); ?> -->
                    <div class="mt-2">
                        <div id="func-absensi">
