...
<div class="form-group row">
    <label for="kode_pegawai_edit" class="col-sm-4 col-form-label">Kode</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="kode_pegawai_edit" name="kode_pegawai_edit" value="<?= $datapegawai['kode_pegawai'] ?>" title="Kode telah otomatis digenerate secara acak pada saat penambahan User" readonly>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?= form_dropdown('role_pegawai_edit', ['' => 'Select Role', 1 => 'Administrator', 2 => 'Pegawai'], set_value('role_pegawai_edit', $datapegawai['role_id']), 'class="form-control" id="role_pegawai_edit"'); ?>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <label for="verifikasi_pegawai_edit" class="col-sm-4 col-form-label">Verifikasi</label>
    <div class="col-sm-8">
        <div class="form-check form-check-inline">
